  ...
  const templates = [
    {
      ...
      preview:
        "Welcome to our community! We're thrilled to have you join our family of innovators and creators...",
      rating: 4.8,
      uses: 1240,
      featured: true,
    ...
    },
    {
      ...
      preview:
        "🚀 We're excited to introduce our latest innovation that will revolutionize how you...",
      rating: 4.9,
      uses: 890,
      featured: true,
    ...
    },
    {
      ...
      preview:
        "💡 Quick question for our community: What's the biggest challenge you're facing in your...",
      rating: 4.6,
      uses: 2100,
      featured: false,
    ...
    },
    {
      ...
      preview:
        "🎄 Holiday Special: Get 30% off everything! Limited time offer - countdown starts now...",
      rating: 4.7,
      uses: 1560,
      featured: true,
    ...
    },
    {
      ...
      preview:
        "How [Customer Name] Increased Revenue by 300% Using Our Platform. Learn about their journey...",
      rating: 4.5,
      uses: 670,
      featured: false,
    ...
    },
    {
      ...
      preview:
        "You're invited to join our exclusive webinar: 'Marketing Automation Secrets'...",
      rating: 4.4,
      uses: 980,
      featured: false,
    ...
    },
    {
      ...
      preview:
        "Swipe-worthy story template with interactive elements and brand consistency...",
      rating: 4.8,
      uses: 3200,
      featured: true,
    ...
    },
    {
      ...
      type: "Automation",
      description:
        "Recover lost sales with this proven cart abandonment sequence",
      preview:
        "Oops! You left something behind. Complete your purchase now and get free shipping...",
      rating: 4.9,
      uses: 1890,
      featured: true,
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-300 mt-1">
              Ready-to-use templates for all your marketing needs
            </p>
          </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold">
                    {Math.round(
                      (templates.reduce((acc, t) => acc + t.rating, 0) /
                        templates.length) *
                        10
                    ) / 10}
                  </div>
