...
import { TestTube, TrendingUp, TrendingDown, Play, Pause, CheckCircle, Clock, BarChart3, Target, Users, Mail, Share2, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Optimize your campaigns with data-driven testing</p>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold">{testStats.runningTests}</div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold">{testStats.completedTests}</div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-green-600">{testStats.averageLift}</div>
                ...
                <div className="text-right">
                  ...
                  {test.winner && (
                    <div className="text-sm">
                      <span className="text-green-600 font-medium">Winner: Variant {test.winner}</span>
                      <div className="text-green-600 font-bold">{test.lift}</div>
                    </div>
                  )}
                </div>
              </div>
                  ...
                  <div key={index} className={`p-4 border rounded-lg ${
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {variant.conversionRate > 0 && (
                        <div className="text-right">
                          <div className="text-lg font-bold">{variant.conversionRate}%</div>
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-3xl">
                        <DialogHeader>
                          ...
                          <DialogDescription>Detailed A/B test results and analytics</DialogDescription>
                        </DialogHeader>
                        <div className="space-y-6">
                          <div className="grid grid-cols-2 gap-4">
                            <div className="text-center p-4 border rounded-lg">
                              <div className="text-2xl font-bold">{test.significance}%</div>
                              <div className="text-sm text-gray-600">Statistical Significance</div>
                            </div>
                            <div className="text-center p-4 border rounded-lg">
                              <div className="text-2xl font-bold text-green-600">{test.lift}</div>
        ...
        <Card>
          <CardContent className="p-12 text-center">
            <div className="text-gray-500">
              ...
              <p>Create your first A/B test to start optimizing your campaigns.</p>
