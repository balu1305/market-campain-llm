...
import { Edit, Save, Eye, Copy, RefreshCw, Wand2, Type, Image, Link, Palette, Download, Upload, FileText, Zap } from 'lucide-react';
...
const ContentEditor = () => {
  ...
  const templates = [
    {
      ...
      name: "Welcome Email",
      type: "email",
      preview: "Welcome to our community! We're excited to have you on board and can't wait to show you what we have in store.",
      category: "Onboarding"
    },
    {
      id: "promotion",
      ...
      type: "email", 
      preview: "🎉 Special offer just for you! Get 25% off your next purchase with code SAVE25. Limited time only!",
      category: "Sales"
    },
    {
      id: "newsletter",
      name: "Newsletter",
      type: "email",
      preview: "This week in tech: The latest trends, product updates, and insights from industry leaders.",
      category: "Newsletter"
    },
    {
      id: "social-post",
      ...
      type: "social",
      preview: "✨ Transform your marketing game with AI-powered content creation. What would you create first? #MarketingAI",
      category: "Social"
    }
  ];
  ...
  const aiSuggestions = [
    ...
    {
      type: "Opening",
      suggestion: "We've been working on something special, and you're among the first to know about it.",
      confidence: 88
    },
    {
      type: "Call to Action",
    ...
    },
    {
      ...
      suggestion: "Consider making the tone more conversational to increase engagement",
      confidence: 85
    }
  ];
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Create and edit marketing content with AI assistance</p>
        </div>
        <div className="flex gap-3">
          <Button variant="outline" className="gap-2" onClick={generateWithAI}>
            ...
            <div className="space-y-2">
              {templates
                ...
                >
                  ...
                  <div className="text-xs text-gray-600 mt-2 line-clamp-2">{template.preview}</div>
                </div>
              ))}
            </div>
          </CardContent>
                  ...
                  <div className="border rounded-lg p-6 bg-gray-50 min-h-[400px]">
                    {contentType === "email" && subject && (
                      <div className="border-b pb-4 mb-4">
                        ...
                        <div className="text-sm text-gray-600">From: marketing@company.com</div>
                      </div>
                    )}
            ...
            <TabsContent value="analysis">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>AI-powered insights about your content</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="text-center p-4 border rounded-lg">
                      <div className="text-2xl font-bold text-green-600">{contentAnalysis.sentimentScore}</div>
                      <div className="text-sm text-gray-600">Sentiment Score</div>
                    </div>
                    <div className="text-center p-4 border rounded-lg">
                      <div className="text-2xl font-bold text-purple-600">{contentAnalysis.engagementPrediction}</div>
                      <div className="text-sm text-gray-600">Engagement Score</div>
                    </div>
                    <div className="text-center p-4 border rounded-lg">
                      <div className="text-2xl font-bold text-orange-600">{contentAnalysis.estimatedReadTime}</div>
            ...
            {aiSuggestions.map((suggestion, index) => (
              <div key={index} className="p-3 border rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-green-600">{suggestion.confidence}% confident</span>
                </div>
                <div className="text-sm text-gray-700 mb-2">{suggestion.suggestion}</div>
                <Button 
                  variant="outline" 
                  size="sm" 
