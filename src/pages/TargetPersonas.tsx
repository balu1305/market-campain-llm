  ...
  const personas = [
    {
      ...
      description:
        "College students looking for affordable products and services",
    ...
    },
    {
      ...
      description:
        "High-income professionals seeking premium technology products",
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-1">
              Understand your audience to create better campaigns
            </p>
          </div>
