  ...
  const socialPosts = [
    {
      ...
      content:
        "📚✨ Broke but make it academic? We got you! Student discount = more money for ramen 🍜 #StudentLife #BudgetFriendly #Study #College #Savings",
    ...
    },
    {
      ...
      persona: "Budget-Conscious Students",
      content:
        "POV: You're a student but still want nice things 💅 Our student discounts said 'say less' 🎓 #StudentDeals #BudgetHacks #College #Student #Discounts",
    ...
    },
    {
      ...
      content:
        "Innovation meets luxury. Our latest collection redefines what's possible in premium technology. #Innovation #LuxuryTech #Premium #Technology #Future",
    ...
    },
    {
      ...
      persona: "Luxury Tech Enthusiasts",
      content:
        "When technology becomes art 🎨 Limited edition. Unlimited possibilities. ✨ #LuxuryTech #Innovation #Exclusive #Art #Premium",
    ...
    },
    {
      ...
      content:
        "Teaching little ones big lessons about our planet 🌱 Every small choice makes a big difference for their future 💚 #EcoFamily #SustainableLiving #FutureEarth #GreenParenting",
    ...
    },
    {
      ...
      persona: "Eco-Friendly Families",
      content:
        "Raising tomorrow's earth heroes 🌍👶 Sustainable choices that don't compromise on fun! #EcoKids #GreenFamily #SustainableParenting #EcoFriendly",
          ...
          <div className="bg-[#1A1A1A] rounded-lg p-6 border border-gray-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">
                  {totalEngagement.reach.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        copyToClipboard(post.content, `post-${post.id}`)
                      }
                ...
                <div className="flex items-center gap-3">
                  <span
                    className={`px-3 py-1 rounded text-sm text-white ${
                      platforms.find((p) => p.id === selectedPost.platform)
                        ?.color || "bg-gray-600"
                    }`}
                  >
                ...
                <div>
                  ...
                  <div className="bg-gray-800 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(selectedPost.content, "modal-content")
                        }
                    ...
                    <div className="bg-gray-800 rounded-lg p-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-white font-semibold">
                            {selectedPost.engagement.shares.toLocaleString()}
                          </span>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
